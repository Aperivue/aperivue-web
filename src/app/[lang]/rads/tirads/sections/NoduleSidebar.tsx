...
import { useReport, locationLabel } from "../report/ReportContext";
import { riskBg } from "@/lib/rads/tirads";
    ...
    <div className="flex flex-col gap-1.5 md:min-w-[180px]">
      ...
      <div className="flex gap-1.5 overflow-x-auto md:flex-col">
        {scoredNodules.map((sn) => {
          ...
          const bg = cat ? riskBg(cat) : "";
          const loc = locationLabel(sn.nodule.location);
          const md = sn.maxDiameter;
          ...
          return (
            ...
            >
              ...
              >
                ...
                {md !== null && <span className="text-foreground/50">{md} cm</span>}
                {cat && (
