...
export const metadata: Metadata = {
  title: "BI-RADS Calculator & Report Generator — Mammography · Ultrasound",
  description:
    "Free breast imaging structured report generator with BI-RADS assessment. Supports mammography and ultrasound. ACR BI-RADS 5th edition descriptors, multi-finding support, and PACS-ready report output.",
  keywords: [
    "BI-RADS",
    "breast imaging",
    "mammography",
...
const PAGE_TEXT = {
  en: {
    ...
    subtitle:
      "Structured reporting with BI-RADS assessment · Mammography & Ultrasound · PACS-ready output",
    disclaimer:
  ...
  ko: {
    ...
    title: "유방 영상 리포트 생성기",
    subtitle:
      "BI-RADS 평가를 포함한 구조화 리포트 · 유방촬영 & 초음파 · PACS 바로 복사",
    disclaimer:
