...
const faqs = [
  ...
  {
    q: "슬래시 명령어를 외워야 하나요?",
    a: "아니요. 하고 싶은 일을 평소 말하듯 설명하면 됩니다. 예: '폐결절 AI 연구 논문 찾아줘', '내 원고 STARD 가이드라인으로 검사해줘.' Claude가 알맞은 스킬을 자동으로 선택합니다. /search-lit이나 /check-reporting 같은 슬래시 명령어는 단축키로 쓸 수 있지만, 필수는 아닙니다.",
  },
  {
    q: "프로그래밍을 전혀 몰라도 되나요?",
    a: "네. MedSci Skills는 프로그래밍 경험이 없는 의사가 만들었습니다. 동료에게 업무를 설명하듯 자연어로 대화하면 됩니다. 코드 작성, 파일 관리, 도구 선택은 Claude가 알아서 처리합니다. 필요한 것은 연구 전문 지식뿐입니다.",
  },
];

export default function FaqContentKo({ lang }: { lang: string }) {
  return (
    <div>
