...
The `check-reporting` skill supports 15 reporting guidelines and risk-of-bias tools:
...
The skill is part of the [medsci-skills](https://github.com/Aperivue/medsci-skills) package, which includes 15 additional skills covering literature search, full-text retrieval, statistical analysis, publication figures, manuscript writing, study design review, and presentation preparation. All 16 skills are MIT licensed and free to use.
