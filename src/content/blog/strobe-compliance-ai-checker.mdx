...
The skill is part of the [medical-research-skills](https://github.com/Aperivue/medical-research-skills) package, which includes eight additional skills covering literature search, statistical analysis, publication figures, study design review, and presentation preparation. All skills are MIT licensed and free to use.
