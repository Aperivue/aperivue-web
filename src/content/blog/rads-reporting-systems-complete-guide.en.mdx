...
Try the free [Lung-RADS calculator](/rads/lungrads), which mirrors this branching logic and produces a screening-ready report.
...
Try the free [LI-RADS calculator](/rads/lirads), which encodes the v2018 precedence rules and major-feature table.
...
Try the free [PI-RADS calculator](/rads/pirads), which follows the v2.1 zone-aware decision rules including the DCE upgrade logic.
...
Try the free [O-RADS calculator](/rads/orads), which supports both the US v2022 and MRI 2022 systems.
